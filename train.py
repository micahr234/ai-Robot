...
agent = AgentTorch(env, "test21", discount=0.99, batch_size=1000, learn_rate=0.0001, learn_iterations=10, memory_buffer_size=1000000, next_learn_factor=0.3, num_of_hypothetical_actions=9)
probMultiple = 0.01
episodes = 300
